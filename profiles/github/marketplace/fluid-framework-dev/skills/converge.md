...
If criteria already exist for this domain (in `.copilot/criteria/` or the project plan), use them. If not, write them — they become a reusable artifact.
...
Persist criteria in the repo (e.g., `.copilot/criteria/`) so they improve across sessions.
